...
use scribe::{contract::EventWithMetadata, events_listener::Poller, metrics};
use std::{env, net::SocketAddr, panic, path::PathBuf, sync::Arc, time::Duration};
...
mod integration_tests {
  ...
  use scribe::{contract::EventWithMetadata, events_handler, events_listener::Poller};
